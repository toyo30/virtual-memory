...
class Scheduling:
    ...
    def add(self, process):
        ...
        self.process_list = sorted(self.process_list, key=lambda Process: Process.arrival)

    def print_result(self, process_list, gantt):
    ...
    def fcfs(self):
        not_arrived = copy.deepcopy(self.process_list)
        ready, end, gantt = [], [], []
        counter = 0
    ...
    def nonpreemptive_priority_with_RR(self):
        not_arrived = copy.deepcopy(self.process_list)
        ready, end, gantt = [], [], []
        quantum = self.time_quantum
        counter = 0
    ...
    def preemptive_priority_with_RR(self):
        not_arrived = copy.deepcopy(self.process_list)
        ready, end, gantt = [], [], []
        quantum = self.time_quantum
        counter = 0
...
for i in range(0, n):
    ...
    scheduling.add(Process(pId, arrival, service, priority))
scheduling.time_quantum = int(input())
print()
...
scheduling.srtf()
scheduling.rr()
scheduling.nonpreemptive_priority()
scheduling.preemptive_priority()
scheduling.nonpreemptive_priority_with_RR()
scheduling.preemptive_priority_with_RR()
scheduling.hrrn()